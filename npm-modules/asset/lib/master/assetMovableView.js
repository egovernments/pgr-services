...
import {ShowFields, UiButton, fileUpload, getInitiatorPosition, UiTable, UiBackButton} from "egov-ui-react-framework";
    ...
    let {handleChange, getVal, addNewCard, removeCard, printer,feeMatrices} = this;
          ...
          const renderBody = function() {
            ...
            console.log(formData);
              ...
              if(formData && formData.hasOwnProperty("Assets") && formData.Assets[0].hasOwnProperty("assetAttributes") && formData.Assets[0].assetAttributes != ""){
                console.log(formData.Assets[0].assetAttributes);
                  ...
                  <Card className="uiCard">
                      ...
                      <CardText>
                      <Row>
             {disArray && disArray.map(function(item, index) {
